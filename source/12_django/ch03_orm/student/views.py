...
def get(request, id:int):
    # student = Student.objects.get(id=id) # pk=id
    # student = get_object_or_404(Student, id=id) # 없는 id면 DoesNotExist → 404
...
def json_test(request):
    # return JsonResponse({'id':1, 'name':'hong', 'major':'ai'}, 
    #                     json_dumps_params={'ensure_ascii':False}) # 한글깨짐방지
