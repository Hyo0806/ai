...
from django.core.validators import MinLengthValidator # 최소글자 예외처리 함수 귀찮을때 사용
...
class Book(models.Model): # book_book 테이블
    ...
    publisher = models.CharField(verbose_name='출판사', max_length=50, null=True, blank=True)
